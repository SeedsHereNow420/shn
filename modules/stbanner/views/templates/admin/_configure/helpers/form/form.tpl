			...
			<div class="modal fade" id="modal_adv_editor" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
				<div class="modal-dialog modal-lg" role="document">
					...
					<div class="modal-header">
						...
						<h4 class="modal-title">{l s='Text editor' d='Admin.Theme.Transformer'} <a href="{$input.name_blank}" target="_blank" title="{l s='Open in new window' d='Admin.Theme.Transformer'}">{l s='Open in a new window' d='Admin.Theme.Transformer'}</a></h4>
					</div>
