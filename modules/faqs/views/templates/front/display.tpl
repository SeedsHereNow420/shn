                    ...
                    <div class="content_home_page_fag">
                        ...
                        {foreach from=$mostFaq item=most}
                            {if ($most['association'] && !$most['hide_faq']) || !$most['association']}
                                ...
                                <a href="{$faqUrl|escape:'htmlall':'UTF-8'}{$most['link_rewrite_cat']|escape:'htmlall':'UTF-8'}/{$most['link_rewrite']|escape:'htmlall':'UTF-8'}.html" class="icon_fag"><i class="material-icons">&#xE157;</i></a><div style="clear: both"></div>
                ...
                <div class="content_home_page_cat">
                    {foreach from=$faqCategories item=faqCategory}
                        ...
                        <div class="category_block">
                            <a class="category_name_home_page name_{$faqCategory['id_gomakoil_faq_category']|escape:'htmlall':'UTF-8'} change_item" style="color: {$faqCategory['color']|escape:'htmlall':'UTF-8'}"  href="{$faqUrl|escape:'htmlall':'UTF-8'}{$faqCategory['link_rewrite']|escape:'htmlall':'UTF-8'}.html">{$faqCategory['name']|escape:'htmlall':'UTF-8'}</a>
                                        ...
                                        {if ($question['association'] && !$question['hide_faq']) || !$question['association']}
                                            ...
                                            {if count($faqCategory['faqs'])>3}
                                                {if $count_fag_in_cat<=3}
                                                    ...
                                                    <a href="{$faqUrl|escape:'htmlall':'UTF-8'}{$faqCategory['link_rewrite']|escape:'htmlall':'UTF-8'}/{$question['link_rewrite']|escape:'htmlall':'UTF-8'}.html" class="icon_fag"><i class="material-icons">&#xE157;</i></a><div style="clear: both"></div>
                                                    <div class="answer_faq">
                                                        {$question['answer']|escape:'htmlall':'UTF-8' nofilter}
                                                    </div>
                                                    {if $count_fag_in_cat == '3'}
                                                        <a class="more_faq_cat" href="{$faqUrl|escape:'htmlall':'UTF-8'}{$faqCategory['link_rewrite']|escape:'htmlall':'UTF-8'}.html" style="color: {$faqCategory['color']|escape:'htmlall':'UTF-8'}" >{l s='show more'  mod='faqs'}</a>
                                                    {/if}
                                                {/if}
                                            {else}
                                                <a class="questions change_item{if $question['as_url']} as_url{/if}" >
                    ...
                    <div class="faq faq_cat">
                        ...
                        {foreach from=$questions['content'] item=question}
                            {if ($question['association'] && !$question['hide_faq']) || !$question['association']}
                                ...
                                <a href="{$faqUrl|escape:'htmlall':'UTF-8'}{$smarty.get.category|escape:'htmlall':'UTF-8'}/{$question['link_rewrite']|escape:'htmlall':'UTF-8'}.html" class="icon_fag"><i class="material-icons">&#xE157;</i></a><div style="clear: both"></div>
                                <div class="answer_faq">
                                    {$question['answer']|escape:'htmlall':'UTF-8' nofilter}
                                </div>
                            {/if}
                    ...
                    {if $search}
                        ...
                        {foreach from=$search item=question}
                            {if ($question['association'] && !$question['hide_faq']) || !$question['association']}
                                ...
                                <a href="{$faqUrl|escape:'htmlall':'UTF-8'}{$question['link_rewrite_cat']|escape:'htmlall':'UTF-8'}/{$question['link_rewrite']|escape:'htmlall':'UTF-8'}.html" class="icon_fag"><i class="material-icons">&#xE157;</i></a><div style="clear: both"></div>
                                <div class="answer_faq">
                                    {$question['answer']|escape:'htmlall':'UTF-8' nofilter}
                                </div>
                            {/if}
