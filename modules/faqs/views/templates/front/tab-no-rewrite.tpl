            ...
            {if isset($faqs) && $faqs}
                <ul class="block_faq_product_page">
                    ...
                    {foreach from=$faqs item=faq}
                        ...
                        <a href="{$faqUrl|escape:'htmlall':'UTF-8'}&category={$faq['link_rewrite_cat']|escape:'htmlall':'UTF-8'}&question={$faq['link_rewrite']|escape:'htmlall':'UTF-8'}" class="icon_fag"><i class="material-icons">&#xE157;</i></a><div style="clear: both"></div>
