...
jQuery(function($){
    $('.st_delete_image').click(function(){
        ...
        $.getJSON(currentIndex+'&token='+token+'&configure=stblogfeaturedarticles&field='+field+'&act=delete_image&ts='+new Date().getTime(),
            function(json){
                if(json.r)
                {
    ...
    $('.delete_slider_image').click(function(){
        ...
        $.getJSON(currentIndex+'&token='+token+'&configure=stblogfeaturedarticles&st_s_id='+s_id+'&st_s_k='+s_k+'&act=delete_slider_image&ts='+new Date().getTime(),
            function(json){
                if(json.r)
                {
