...
{foreach from=$languages item=language}
	...
	{/if}
		...
		<div class="input-group">
			...
			value="{$input_value[$language.id_lang]|htmlentitiesUTF8|default:''|no_escape}"
	...
	{if $languages|count > 1}
		...
		<div class="col-lg-2">
			...
			<ul class="dropdown-menu">
				{foreach from=$languages item=language}
				<li>
					<a href="javascript:tabs_manager.allow_hide_other_languages = false;hideOtherLanguage({$language.id_lang|escape:'quotes':'UTF-8'});">{$language.name|escape:'quotes':'UTF-8'}</a>
				</li>
				{/foreach}
			</ul>
		</div>
