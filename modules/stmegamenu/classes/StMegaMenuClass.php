...
class StMegaMenuClass extends ObjectModel
{
    ...
    public static function getTypes()
    {
		...
		return array(
			1 => $module->getTranslator()->trans('Category', array(), 'Admin.Theme.Transformer'),
			2 => $module->getTranslator()->trans('Product', array(), 'Admin.Theme.Transformer'),
			3 => $module->getTranslator()->trans('CMS', array(), 'Admin.Theme.Transformer'),
			4 => $module->getTranslator()->trans('Manufacturer', array(), 'Admin.Theme.Transformer'),
			5 => $module->getTranslator()->trans('Supplier', array(), 'Admin.Theme.Transformer'),
			6 => $module->getTranslator()->trans('Shop', array(), 'Admin.Theme.Transformer'),
			7 => $module->getTranslator()->trans('Link', array(), 'Admin.Theme.Transformer'),
			8 => $module->getTranslator()->trans('CMS category', array(), 'Admin.Theme.Transformer'),
			9 => $module->getTranslator()->trans('ICON', array(), 'Admin.Theme.Transformer'),
			10 => $module->getTranslator()->trans('Blog category', array(), 'Admin.Theme.Transformer'),
			11 => $module->getTranslator()->trans('Blog', array(), 'Admin.Theme.Transformer'),
			12 => $module->getTranslator()->trans('Permanent link', array(), 'Admin.Theme.Transformer'),
		);
    }
