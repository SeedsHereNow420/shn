...
function cp_display_gallery_page($files_array, $pageno = 1, $path = '', $resultspp = 4096, $display = true)
{
    $pagination = array();
...
function cp_display_gallery_pagination($url = '', $totalresults = 0, $pageno = 1, $resultspp = 4096, $display = true)
{
    $configp = array();
    ...
    $output = cp_get_gallery_html($configp);
...
function cp_get_gallery_html($pconfig/*, $ext = ''*/)
{
    $links_html = '';
