	...
	window.kmUI  = {
		...
		notify: {
			...
			show: function( settings ) {
				...
				var $notification 	= $('.cp-notify-osd'),
			...
			hide: function() {
				...
				$('.cp-notify-osd').removeClass('visible');
			}
		},
			...
			open : function( el, po ) {
				...
				setTimeout( function(){
					...
					if( po ){
						...
						$popover.find( '.km-ui-popover-inner' ).html( $el.siblings( '.cp-popover-data, .km-ui-popover-data' ).html() );
