...
class FormElement3 extends StEasyContent
{
    ...
    public function initFormElementSetting()
    {
        ...
        $this->fields_form[0]['form'] = array(
            'legend' => array(
                'title' => $this->getTranslator()->trans('Accordion settings:', array(), 'Modules.Stsasycontent.Admin'),
                'icon' => 'icon-cogs',                
            ),
            'input' => array(
                ...
                array(
                    'type' => 'radio',
                    'label' => $this->getTranslator()->trans('Default state:', array(), 'Modules.Stsasycontent.Admin'),
                    'name' => 'st_state',
                    'default_value' => 0,
                    'values' => array(
                        array(
                            'id' => 'st_state_0',
                            'value' => 0,
                            'label' => $this->getTranslator()->trans('Open the first one', array(), 'Modules.Stsasycontent.Admin')),
                        array(
                            'id' => 'st_state_1',
                            'value' => 1,
                            'label' => $this->getTranslator()->trans('Open all', array(), 'Modules.Stsasycontent.Admin')),
                        array(
                            'id' => 'st_state_2',
                            'value' => 2,
                            'label' => $this->getTranslator()->trans('Close all', array(), 'Modules.Stsasycontent.Admin')),
                    ),
                    'validation' => 'isUnsignedInt',
                ),
                array(
                ...
                array(
                    'type' => 'color',
                    'label' => $this->getTranslator()->trans('Active header color:', array(), 'Modules.Stsasycontent.Admin'),
                ...
                array(
                    'type' => 'color',
                    'label' => $this->getTranslator()->trans('Header background:', array(), 'Admin.Theme.Transformer'),
                    'name' => 'st_header_bg',
                    'size' => 33,
                    'default_value' => '',
                    'validation' => 'isColor',
                ...
                array(
                    'type' => 'color',
                    'label' => $this->getTranslator()->trans('Active header background:', array(), 'Modules.Stsasycontent.Admin'),
        ...
        $this->fields_form[1]['form'] = array(
            ...
            'input' => array(
                array(
                    'type' => 'fontello',
                    'label' => $this->getTranslator()->trans('Open sign:', array(), 'Modules.Stsasycontent.Admin'),
                    'name' => 'st_icon_open',
                ...
                array(
                    'type' => 'fontello',
                    'label' => $this->getTranslator()->trans('Close sign:', array(), 'Modules.Stsasycontent.Admin'),
                    'name' => 'st_icon_close',
                    'values' => $this->get_fontello(),
                    'validation' => 'isGenericName',
                ...
                array(
                    'type' => 'color',
                    'label' => $this->getTranslator()->trans('Icon color:', array(), 'Modules.Stsasycontent.Admin'),
                    'name' => 'st_icon_color',
                    'size' => 33,
                    'default_value' => '',
                    'validation' => 'isColor',
                ...
                array(
                    'type' => 'color',
                    'label' => $this->getTranslator()->trans('Icon hover color:', array(), 'Modules.Stsasycontent.Admin'),
                ...
                array(
                    'type' => 'color',
                    'label' => $this->getTranslator()->trans('Icon background:', array(), 'Admin.Theme.Transformer'),
                    'name' => 'st_icon_bg',
                    'size' => 33,
                    'default_value' => '',
                    'validation' => 'isColor',
                ...
                array(
                    'type' => 'color',
                    'label' => $this->getTranslator()->trans('Icon hover background:', array(), 'Admin.Theme.Transformer'),
        ...
        $this->fields_form[2]['form'] = array(
            'legend' => array(
                'title' => $this->getTranslator()->trans('Content settings:', array(), 'Admin.Theme.Transformer'),
                'icon' => 'icon-cogs'                
            ),
            'input' => array(
                array(
                ...
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('Padding left and right:', array(), 'Admin.Theme.Transformer'),
                ...
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('Padding top and bottom:', array(), 'Admin.Theme.Transformer'),
