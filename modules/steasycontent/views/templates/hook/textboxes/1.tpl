...
<img src="{if $element.st_image|strpos:'/modules/' !== false}{$element.st_image}{else}{$easy_image_path|cat:$element.st_image}{/if}" class="easy_image mar_b1" alt="{if $element.st_el_header}{$element.st_el_header}{/if}">
{/if}
...
{/if}
{if isset($element.st_el_header) && $element.st_el_header}<h6 class="easy_header">{$element.st_el_header}</h6>{/if}
