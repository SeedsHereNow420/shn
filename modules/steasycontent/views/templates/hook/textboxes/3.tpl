...
<div class="flex_container m-b-1">
	...
	<div class="flex_child">
		{if $element.st_el_header}<h6 class="easy_header mar_b4">{$element.st_el_header}</h6>{/if}
		{if $element.st_el_sub_header}<div class="easy_sub_header">{$element.st_el_sub_header}</div>{/if}
	</div>
</div>
