...
<div class="easy_icon_with_text_{if isset($element.st_el_icon_with_text)}{$element.st_el_icon_with_text}{/if} flex_container flex_start">
	<em class="{$element.st_el_icon} easy_icon fs_md color_444"><span class="unvisible">&nbsp;</span></em>
	<div class="flex_child">
		...
		{if isset($element.st_el_text) && $element.st_el_text}<div class="easy_text {if !$element.st_el_url} pad_b6{/if}">{$element.st_el_text}</div>{/if}
