<?php /* Smarty version Smarty-3.1.19, created on 2019-01-04 09:22:14
         compiled from "/var/www/html/SHN/themes/transformer/templates/customer/authentication.tpl" */ ?>
<?php /*%%SmartyHeaderCode:21424835975c2f9646df1f14-42505536%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '93f0645fd77267cb45351be367198cb213e442e8' => 
    array (
      0 => '/var/www/html/SHN/themes/transformer/templates/customer/authentication.tpl',
      1 => 1512351208,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '21424835975c2f9646df1f14-42505536',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5c2f9647096464_97608883',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c2f9647096464_97608883')) {function content_5c2f9647096464_97608883($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/var/www/html/SHN/vendor/prestashop/smarty/plugins/modifier.replace.php';
?><!doctype html>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('_partials/head.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '21424835975c2f9646df1f14-42505536');
content_5c2f9646e565d5_42684175($_smarty_tpl);
...
" class="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['page']->value['page_name'], ENT_QUOTES, 'UTF-8');?>
 ...
 <?php if ($_smarty_tpl->tpl_vars['language']->value['is_rtl']) {?> is_rtl <?php }?>
  ...
  <?php if ($_smarty_tpl->tpl_vars['sttheme']->value['use_mobile_header']==2) {?> use_mobile_header <?php }?>
	 hide-left-column hide-right-column  login_page 
  ">
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('catalog/_partials/product-activation.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '21424835975c2f9646df1f14-42505536');
content_5c2f9646eac3e1_80740943($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('_partials/header.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '21424835975c2f9646df1f14-42505536');
content_5c2f9646eb6020_69708876($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('_partials/notifications.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '21424835975c2f9646df1f14-42505536');
content_5c2f9646f17fb4_72137679($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
<?php $_smarty_tpl->tpl_vars["auth_login_width"] = new Smarty_variable(6, null, 0);?>
<?php if ($_smarty_tpl->tpl_vars['sttheme']->value['auth_login_width']) {?><?php $_smarty_tpl->tpl_vars['auth_login_width'] = new Smarty_variable($_smarty_tpl->tpl_vars['sttheme']->value['auth_login_width'], null, 0);?><?php }?>
    <div class="row">
    <?php if ($_smarty_tpl->tpl_vars['sttheme']->value['auth_layout']) {?>
    
      <div class="col-lg-<?php echo htmlspecialchars(12-$_smarty_tpl->tpl_vars['auth_login_width']->value, ENT_QUOTES, 'UTF-8');?>
">
        <section id="create_account_block" class="from_blcok block login_form_block">
          <?php if ($_smarty_tpl->tpl_vars['sttheme']->value['auth_heading_align']!=3) {?><h3 class="page_heading login_form_heading <?php if ($_smarty_tpl->tpl_vars['sttheme']->value['auth_heading_align']==1) {?> text-2 <?php } elseif ($_smarty_tpl->tpl_vars['sttheme']->value['auth_heading_align']==2) {?> text-3 <?php } else { ?> text-1 <?php }?>"><?php echo smartyTranslate(array('s'=>'New customers?','d'=>'Shop.Theme.Transformer'),$_smarty_tpl);?>
</h3><?php }?>
          <div class="form_content">
          <div class="form_content_inner">
              <div class="p-b-1"><?php echo smartyTranslate(array('s'=>'It\'s quick and easy to create an account to shop faster and save your order to account.','d'=>'Shop.Theme.Transformer'),$_smarty_tpl);?>
</div>
          </div>
          <?php if (isset($_smarty_tpl->tpl_vars['oasl_login_disable']->value)&&$_smarty_tpl->tpl_vars['oasl_login_disable']->value==2) {?><?php echo $_smarty_tpl->tpl_vars['HOOK_OASL_CUSTOM']->value;?>
<?php }?>
          </div>
          <footer class="form-footer">
              <a class="btn btn-primary btn-large js-btn-active btn-spin btn-full-width" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['urls']->value['pages']['register'], ENT_QUOTES, 'UTF-8');?>
" data-link-action="display-register-form" id="SubmitCreate" rel="nofollow">
                  <i class="fto-user icon_btn"></i>
                  <?php echo smartyTranslate(array('s'=>'Create an account','d'=>'Shop.Theme.Actions'),$_smarty_tpl);?>
    ...
    <?php }?>
      ...
      <div class="<?php if ($_smarty_tpl->tpl_vars['sttheme']->value['auth_layout']) {?> col-lg-<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['auth_login_width']->value, ENT_QUOTES, 'UTF-8');?>
 <?php } else { ?> col-lg-<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['auth_login_width']->value, ENT_QUOTES, 'UTF-8');?>
 <?php if ($_smarty_tpl->tpl_vars['layout']->value=='layouts/layout-full-width.tpl') {?>offset-lg-<?php echo htmlspecialchars(floor((12-$_smarty_tpl->tpl_vars['auth_login_width']->value)/2), ENT_QUOTES, 'UTF-8');?>
<?php }?> <?php }?>">
        <section id="login_form_block" class="from_blcok block login_form_block <?php if (!$_smarty_tpl->tpl_vars['sttheme']->value['auth_layout']) {?> one_column_login <?php }?>">
          <?php if ($_smarty_tpl->tpl_vars['sttheme']->value['auth_heading_align']!=3) {?><h3 class="page_heading <?php if ($_smarty_tpl->tpl_vars['sttheme']->value['auth_heading_align']==1) {?> text-2 <?php } elseif ($_smarty_tpl->tpl_vars['sttheme']->value['auth_heading_align']==2) {?> text-3 <?php } else { ?> text-1 <?php }?>"><?php echo smartyTranslate(array('s'=>'Registered customers','d'=>'Shop.Theme.Transformer'),$_smarty_tpl);?>
</h3><?php }?>
          ...
          <div class="form_content_inner text-center p-t-1">
            <h6 class="fs_lg heading_color heading_font"><?php echo smartyTranslate(array('s'=>'New customers?','d'=>'Shop.Theme.Transformer'),$_smarty_tpl);?>
</h6>
            <div class="p-b-1"><?php echo smartyTranslate(array('s'=>'It\'s quick and easy to create an account to shop faster and save your order to account.','d'=>'Shop.Theme.Transformer'),$_smarty_tpl);?>
</div>
          </div>
...
" class="no_account btn btn-default btn-large js-btn-active btn-spin btn-full-width" data-link-action="display-register-form" title="<?php echo smartyTranslate(array('s'=>'No account? Create one here','d'=>'Shop.Theme.Customeraccount'),$_smarty_tpl);?>
">
              <i class="fto-user icon_btn"></i><?php echo smartyTranslate(array('s'=>'Create an account','d'=>'Shop.Theme.Customeraccount'),$_smarty_tpl);?>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("_partials/footer.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '21424835975c2f9646df1f14-42505536');
content_5c2f9647049639_37264914($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("_partials/javascript.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('javascript'=>$_smarty_tpl->tpl_vars['javascript']->value['bottom']), 0, '21424835975c2f9646df1f14-42505536');
content_5c2f9646e89706_97570390($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
<?php if ($_valid && !is_callable('content_5c2f9646e565d5_42684175')) {function content_5c2f9646e565d5_42684175($_smarty_tpl) {?>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("_partials/stylesheets.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('stylesheets'=>$_smarty_tpl->tpl_vars['stylesheets']->value), 0, '21424835975c2f9646df1f14-42505536');
content_5c2f9646e7a032_53351617($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
/*  End of included template "_partials/stylesheets.tpl" */?>
  ...
  <?php /*  Call merged included template "_partials/javascript.tpl" */
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("_partials/javascript.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('javascript'=>$_smarty_tpl->tpl_vars['javascript']->value['head'],'vars'=>$_smarty_tpl->tpl_vars['js_custom_vars']->value), 0, '21424835975c2f9646df1f14-42505536');
content_5c2f9646e89706_97570390($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
/*  End of included template "_partials/javascript.tpl" */?>
...
<?php if ($_valid && !is_callable('content_5c2f9646e7a032_53351617')) {function content_5c2f9646e7a032_53351617($_smarty_tpl) {?>
...
<?php if ($_valid && !is_callable('content_5c2f9646e89706_97570390')) {function content_5c2f9646e89706_97570390($_smarty_tpl) {?>
...
<?php if ($_valid && !is_callable('content_5c2f9646eac3e1_80740943')) {function content_5c2f9646eac3e1_80740943($_smarty_tpl) {?>
...
<?php if ($_valid && !is_callable('content_5c2f9646eb6020_69708876')) {function content_5c2f9646eb6020_69708876($_smarty_tpl) {?>
...
<?php if ($_valid && !is_callable('content_5c2f9646f17fb4_72137679')) {function content_5c2f9646f17fb4_72137679($_smarty_tpl) {?>
...
<?php }?><?php }} ?>
<?php /* Smarty version Smarty-3.1.19, created on 2019-01-04 09:22:15
         compiled from "/var/www/html/SHN/themes/transformer/templates/_partials/footer.tpl" */ ?>
<?php if ($_valid && !is_callable('content_5c2f9647049639_37264914')) {function content_5c2f9647049639_37264914($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/var/www/html/SHN/vendor/prestashop/smarty/plugins/modifier.replace.php';
?>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('_partials/footer-bottom.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '21424835975c2f9646df1f14-42505536');
content_5c2f964706bab6_87831813($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
<?php if ($_valid && !is_callable('content_5c2f964706bab6_87831813')) {function content_5c2f964706bab6_87831813($_smarty_tpl) {?>
