...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5c2e7ac586d174_65334087',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c2e7ac586d174_65334087')) {function content_5c2e7ac586d174_65334087($_smarty_tpl) {?><!-- begin /var/www/html/SHN/modules/stthemeeditor/views/templates/slider/homepage.tpl -->
...
<?php }?>
        ...
        <?php if ($_smarty_tpl->tpl_vars['pro_or_blog_slider']->value==1) {?>
            ...
            <div class="block_content">
                <?php echo $_smarty_tpl->getSubTemplate ("catalog/slider/product-slider.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, null, array(), 0);?>

            </div>
            <?php echo $_smarty_tpl->getSubTemplate ("catalog/slider/script.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, null, array('block_name'=>"#".((string)$_smarty_tpl->tpl_vars['module']->value)."_container_".((string)$_smarty_tpl->tpl_vars['hook_hash']->value)), 0);?>

            <?php } elseif ($_smarty_tpl->tpl_vars['display_as_grid']->value==2) {?>
                <?php echo $_smarty_tpl->getSubTemplate ("catalog/listing/product-list-simple.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, null, array('for_f'=>((string)$_smarty_tpl->tpl_vars['module']->value)), 0);?>

            <?php } else { ?>
                <?php echo $_smarty_tpl->getSubTemplate ("catalog/_partials/miniatures/list-item.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, null, array('class'=>((string)$_smarty_tpl->tpl_vars['module']->value)."_grid",'for_f'=>((string)$_smarty_tpl->tpl_vars['module']->value)), 0);?>

            <?php }?>
    	<?php } elseif ($_smarty_tpl->tpl_vars['pro_or_blog_slider']->value==2) {?>
            <?php if (!$_smarty_tpl->tpl_vars['display_as_grid']->value||$_smarty_tpl->tpl_vars['column_slider']->value) {?>
            <div class="block_content">
                <?php echo $_smarty_tpl->getSubTemplate ("module:stblog/views/templates/slider/slider.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, null, array(), 0);?>

            </div>
            <?php echo $_smarty_tpl->getSubTemplate ("catalog/slider/script.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, null, array('block_name'=>"#".((string)$_smarty_tpl->tpl_vars['module']->value)."_container_".((string)$_smarty_tpl->tpl_vars['hook_hash']->value),'is_product_slider'=>0), 0);?>

            <?php } else { ?>
                <?php echo $_smarty_tpl->getSubTemplate ("module:stblog/views/templates/slider/list-item.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, null, array('for_f'=>((string)$_smarty_tpl->tpl_vars['module']->value)), 0);?>
...
<?php }?><!-- end /var/www/html/SHN/modules/stthemeeditor/views/templates/slider/homepage.tpl --><?php }} ?>
