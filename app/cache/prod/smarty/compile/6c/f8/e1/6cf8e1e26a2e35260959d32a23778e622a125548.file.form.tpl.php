<?php /* Smarty version Smarty-3.1.19, created on 2019-01-07 12:39:22
         compiled from "/var/www/html/SHN/nimda420/themes/default/template/controllers/addresses/helpers/form/form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:14062385845c33b8fa8f3104-76823001%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6cf8e1e26a2e35260959d32a23778e622a125548' => 
    array (
      0 => '/var/www/html/SHN/nimda420/themes/default/template/controllers/addresses/helpers/form/form.tpl',
      1 => 1508771956,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '14062385845c33b8fa8f3104-76823001',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5c33b8fe50fca0_35832425',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c33b8fe50fca0_35832425')) {function content_5c33b8fe50fca0_35832425($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include '/var/www/html/SHN/vendor/prestashop/smarty/plugins/function.counter.php';
?>
...
" />
	...
	<?php if ($_smarty_tpl->tpl_vars['input']->value['type']=='text_customer'&&!isset($_smarty_tpl->tpl_vars['customer']->value)) {?>
		<label class="control-label col-lg-3 required" for="email"><?php echo smartyTranslate(array('s'=>'Customer email','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl);?>
</label>
	<?php } else { ?>
		...
		<?php } else { ?>
			...
			$('input[name=email]').live('blur', function(e)
			{
				...
				if (email.length > 5)
				{
					var data = {};
					data.email = email;
					data.token = "<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['token']->value,'html','UTF-8');?>
";
					data.ajax = 1;
			...
			<div class="col-lg-4">
				<input type="email" id="email" name="email" value="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['fields_value']->value[$_smarty_tpl->tpl_vars['input']->value['name']],'html','UTF-8');?>
"/>
			</div>
		<?php }?>
	<?php } else { ?>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('helpers/form/form_group.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '14062385845c33b8fa8f3104-76823001');
content_5c33b8fda19f77_74336777($_smarty_tpl);
...
<?php }?>
<?php }} ?>
<?php /* Smarty version Smarty-3.1.19, created on 2019-01-07 12:39:25
         compiled from "/var/www/html/SHN/nimda420/themes/default/template/helpers/form/form_group.tpl" */ ?>
<?php if ($_valid && !is_callable('content_5c33b8fda19f77_74336777')) {function content_5c33b8fda19f77_74336777($_smarty_tpl) {?>
