...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5c32fdb695c510_59644382',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c32fdb695c510_59644382')) {function content_5c32fdb695c510_59644382($_smarty_tpl) {?><!-- MODULE st owl carousel -->
...
" class="owl_carousel_wrap st_owl_carousel_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['group']->value['templates'], ENT_QUOTES, 'UTF-8');?>
 <?php if (!$_smarty_tpl->tpl_vars['group']->value['is_full_width']) {?> block <?php }?> owl_images_slider <?php if ($_smarty_tpl->tpl_vars['group']->value['hide_on_mobile']==1) {?> hidden-md-down <?php } elseif ($_smarty_tpl->tpl_vars['group']->value['hide_on_mobile']==2) {?> hidden-lg-up <?php }?>">
                <?php echo $_smarty_tpl->getSubTemplate ("module:stowlcarousel/views/templates/hook/stowlcarousel-".((string)$_smarty_tpl->tpl_vars['group']->value['templates']).".tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, null, array('slides'=>$_smarty_tpl->tpl_vars['group']->value), 0);?>
