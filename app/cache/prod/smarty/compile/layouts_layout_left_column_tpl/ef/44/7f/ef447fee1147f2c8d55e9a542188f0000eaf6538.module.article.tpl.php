<?php /* Smarty version Smarty-3.1.19, created on 2019-01-07 01:04:59
         compiled from "module:stblog/views/templates/front/article.tpl" */ ?>
<?php /*%%SmartyHeaderCode:11731103435c33163be80a00-45389946%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ef447fee1147f2c8d55e9a542188f0000eaf6538' => 
    array (
      0 => 'module:stblog/views/templates/front/article.tpl',
      1 => 1512351208,
      2 => 'module',
    ),
  ...
  'nocache_hash' => '11731103435c33163be80a00-45389946',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5c33163c306627_67122561',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c33163c306627_67122561')) {function content_5c33163c306627_67122561($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/var/www/html/SHN/vendor/prestashop/smarty/plugins/modifier.replace.php';
?><!doctype html>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('_partials/head.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '11731103435c33163be80a00-45389946');
content_5c33163be922e0_23373340($_smarty_tpl);
...
" class="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['page']->value['page_name'], ENT_QUOTES, 'UTF-8');?>
 ...
 <?php if ($_smarty_tpl->tpl_vars['language']->value['is_rtl']) {?> is_rtl <?php }?>
  ...
  <?php if ($_smarty_tpl->tpl_vars['sttheme']->value['use_mobile_header']==2) {?> use_mobile_header <?php }?>
	 show-left-column hide-right-column  is_blog 
  ">
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('catalog/_partials/product-activation.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '11731103435c33163be80a00-45389946');
content_5c33163bec6d07_02444924($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('_partials/header.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '11731103435c33163be80a00-45389946');
content_5c33163becbac4_32193494($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('_partials/notifications.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '11731103435c33163be80a00-45389946');
content_5c33163bf151c9_15423411($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
/*  End of included template "_partials/notifications.tpl" */?>
	  

	  
  <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>'displayStBlogArticleTop'),$_smarty_tpl);?>
...
<?php if (isset($_smarty_tpl->tpl_vars['blog']->value)) {?>
	<?php if ($_smarty_tpl->tpl_vars['blog']->value['id']) {?>
        <div id="blog_primary_block" itemscope itemtype="http://schema.org/NewsArticle">
            ...
            <h1 class="page_heading blog_heading" itemprop="headline"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['blog']->value['name'], ENT_QUOTES, 'UTF-8');?>
</h1>

            <div class="blog_info m-b-1">
                <?php if ($_smarty_tpl->tpl_vars['stblog']->value['display_date']) {?>
                <span class="posted_on"><?php echo smartyTranslate(array('s'=>'Posted on','d'=>'Shop.Theme.Transformer'),$_smarty_tpl);?>
</span><span class="date-add"><?php if ($_smarty_tpl->tpl_vars['stblog']->value['display_date']==2) {?><?php if (!count($_smarty_tpl->tpl_vars['blog']->value['timeago'])) {?><?php echo smartyTranslate(array('s'=>'Just now','d'=>'Shop.Theme.Transformer'),$_smarty_tpl);?>
...
<?php }?></span><meta itemprop="datePublished" content="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['dateFormat'][0][0]->dateFormat(array('date'=>$_smarty_tpl->tpl_vars['blog']->value['date_add'],'full'=>0),$_smarty_tpl);?>
"/>
                <?php }?>
                <?php if (isset($_smarty_tpl->tpl_vars['blog']->value['author'])&&$_smarty_tpl->tpl_vars['blog']->value['author']) {?>
                    <span class="posted_by"><?php echo smartyTranslate(array('s'=>'by','d'=>'Shop.Theme.Transformer'),$_smarty_tpl);?>
</span>
                    <span class="posted_author link_color" itemprop="author" itemscope itemtype="https://schema.org/Person"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['blog']->value['author'], ENT_QUOTES, 'UTF-8');?>
<meta itemprop="name" content="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['blog']->value['author'], ENT_QUOTES, 'UTF-8');?>
"></span>
                <?php }?>
                <?php if ($_smarty_tpl->tpl_vars['stblog']->value['display_viewcount']) {?><span><i class="fto-eye-2 mar_r"></i><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['blog']->value['counter'], ENT_QUOTES, 'UTF-8');?>
</span><?php }?>
                <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>'displayStBlogArticleInfo'),$_smarty_tpl);?>

            </div>
            <div class="hidden" itemprop="publisher" itemscope itemtype="https://schema.org/Organization">
                <div itemprop="logo" itemscope itemtype="https://schema.org/ImageObject">
                  <meta itemprop="url" content="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['shop']->value['logo'], ENT_QUOTES, 'UTF-8');?>
">
                  <?php if (isset($_smarty_tpl->tpl_vars['sttheme']->value['st_logo_image_width'])&&$_smarty_tpl->tpl_vars['sttheme']->value['st_logo_image_width']) {?><meta itemprop="width" content="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['sttheme']->value['st_logo_image_width'], ENT_QUOTES, 'UTF-8');?>
"><?php }?>
                  <?php if (isset($_smarty_tpl->tpl_vars['sttheme']->value['st_logo_image_height'])&&$_smarty_tpl->tpl_vars['sttheme']->value['st_logo_image_height']) {?><meta itemprop="height" content="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['sttheme']->value['st_logo_image_height'], ENT_QUOTES, 'UTF-8');?>
"><?php }?>
                </div>
                <meta itemprop="name" content="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['shop']->value['name'], ENT_QUOTES, 'UTF-8');?>
">
            </div>
            <?php if (!isset($_smarty_tpl->tpl_vars['blog']->value['author'])||!$_smarty_tpl->tpl_vars['blog']->value['author']) {?>
...
">
            ...
            <?php if ((isset($_smarty_tpl->tpl_vars['blog']->value['cover'])&&$_smarty_tpl->tpl_vars['blog']->value['cover'])||($_smarty_tpl->tpl_vars['blog']->value['type']==3&&$_smarty_tpl->tpl_vars['blog']->value['video'])) {?>
            <div class="m-b-1">
                <?php /*  Call merged included template "module:stblog/views/templates/slider/post-cover.tpl" */
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('module:stblog/views/templates/slider/post-cover.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('blog_image_type'=>'large','is_lazy'=>0,'show_video'=>1), 0, '11731103435c33163be80a00-45389946');
content_5c33163c038348_41833585($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
/*  End of included template "module:stblog/views/templates/slider/post-cover.tpl" */?>  
            </div>
            <?php }?>

            <?php if ($_smarty_tpl->tpl_vars['stblog']->value['display_short_content']) {?>
                <div class="m-b-1 blog_short_content" itemprop="description"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['blog']->value['content_short'], ENT_QUOTES, 'UTF-8');?>
</div>
            <?php }?>
            ...
            <?php if ($_smarty_tpl->tpl_vars['blog_tags']->value&&count($_smarty_tpl->tpl_vars['blog_tags']->value)) {?>
                <div id="blog_tags" class="general_bottom_border">
                    <?php echo smartyTranslate(array('s'=>'Tag','d'=>'Shop.Theme.Transformer'),$_smarty_tpl);?>
:
...
?>
                        <a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->getUrlSmarty(array('entity'=>'module','name'=>'stblogsearch','controller'=>'default','params'=>array('stb_search_query'=>$_smarty_tpl->tpl_vars['tag']->value)),$_smarty_tpl);?>
...
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['tag']->value, ENT_QUOTES, 'UTF-8');?>
        ...
        <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>'displayStBlogArticleFooter'),$_smarty_tpl);?>

        
        <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>'displayStBlogArticleSecondary'),$_smarty_tpl);?>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("_partials/footer.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '11731103435c33163be80a00-45389946');
content_5c33163c18a0f9_08820752($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("_partials/javascript.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('javascript'=>$_smarty_tpl->tpl_vars['javascript']->value['bottom']), 0, '11731103435c33163be80a00-45389946');
content_5c33163beae924_17721333($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
<?php if ($_valid && !is_callable('content_5c33163be922e0_23373340')) {function content_5c33163be922e0_23373340($_smarty_tpl) {?>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("_partials/stylesheets.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('stylesheets'=>$_smarty_tpl->tpl_vars['stylesheets']->value), 0, '11731103435c33163be80a00-45389946');
content_5c33163bea6164_59627221($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
/*  End of included template "_partials/stylesheets.tpl" */?>
  ...
  <?php /*  Call merged included template "_partials/javascript.tpl" */
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("_partials/javascript.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('javascript'=>$_smarty_tpl->tpl_vars['javascript']->value['head'],'vars'=>$_smarty_tpl->tpl_vars['js_custom_vars']->value), 0, '11731103435c33163be80a00-45389946');
content_5c33163beae924_17721333($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
/*  End of included template "_partials/javascript.tpl" */?>
...
<?php if ($_valid && !is_callable('content_5c33163bea6164_59627221')) {function content_5c33163bea6164_59627221($_smarty_tpl) {?>
...
<?php if ($_valid && !is_callable('content_5c33163beae924_17721333')) {function content_5c33163beae924_17721333($_smarty_tpl) {?>
...
<?php if ($_valid && !is_callable('content_5c33163bec6d07_02444924')) {function content_5c33163bec6d07_02444924($_smarty_tpl) {?>
...
<?php if ($_valid && !is_callable('content_5c33163becbac4_32193494')) {function content_5c33163becbac4_32193494($_smarty_tpl) {?>
...
<?php if ($_valid && !is_callable('content_5c33163bf151c9_15423411')) {function content_5c33163bf151c9_15423411($_smarty_tpl) {?>
...
<?php }?><?php }} ?>
<?php /* Smarty version Smarty-3.1.19, created on 2019-01-07 01:05:00
         compiled from "module:stblog/views/templates/slider/post-cover.tpl" */ ?>
<?php if ($_valid && !is_callable('content_5c33163c038348_41833585')) {function content_5c33163c038348_41833585($_smarty_tpl) {?>
...
<?php if ($_valid && !is_callable('content_5c33163c18a0f9_08820752')) {function content_5c33163c18a0f9_08820752($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/var/www/html/SHN/vendor/prestashop/smarty/plugins/modifier.replace.php';
?>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('_partials/footer-bottom.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '11731103435c33163be80a00-45389946');
content_5c33163c290c46_40982915($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
<?php if ($_valid && !is_callable('content_5c33163c290c46_40982915')) {function content_5c33163c290c46_40982915($_smarty_tpl) {?>
