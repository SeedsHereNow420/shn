...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/stock')) {
            ...
            if (preg_match('#^/stock/(?P<hash>[^/\\.]++)\\.hot\\-update\\.json$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not__admin_stock_hot_reload_json;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => '_admin_stock_hot_reload_json')), array (  '_controller' => 'PrestaShopBundle\\Controller\\Admin\\StockController::hashUpdateJsonAction',));
            }
            not__admin_stock_hot_reload_json:

            // _admin_stock_hot_reload_js
            if (preg_match('#^/stock/(?P<hash>.+)\\.hot\\-update\\.js$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not__admin_stock_hot_reload_js;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => '_admin_stock_hot_reload_js')), array (  '_controller' => 'PrestaShopBundle\\Controller\\Admin\\StockController::hashUpdateJsAction',));
            }
        ...
        if (0 === strpos($pathinfo, '/international')) {
            ...
            if (preg_match('#^/international/(?P<hash>[^/\\.]++)\\.hot\\-update\\.json$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not__admin_translations_hot_reload_json;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => '_admin_translations_hot_reload_json')), array (  '_controller' => 'PrestaShopBundle\\Controller\\Admin\\TranslationsController::hashUpdateJsonAction',));
            }
            not__admin_translations_hot_reload_json:

            // _admin_translations_hot_reload_js
            if (preg_match('#^/international/(?P<hash>.+)\\.hot\\-update\\.js$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not__admin_translations_hot_reload_js;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => '_admin_translations_hot_reload_js')), array (  '_controller' => 'PrestaShopBundle\\Controller\\Admin\\TranslationsController::hashUpdateJsAction',));
            }
