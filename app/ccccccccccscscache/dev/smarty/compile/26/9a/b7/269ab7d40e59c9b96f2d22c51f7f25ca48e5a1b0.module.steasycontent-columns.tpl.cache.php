...
<?php /*%%SmartyHeaderCode:14793014015c3185878ebeb2-39638720%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '14793014015c3185878ebeb2-39638720',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5c3185878fecc7_87570683',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c3185878fecc7_87570683')) {function content_5c3185878fecc7_87570683($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/var/www/html/SHN/vendor/prestashop/smarty/plugins/function.math.php';
...
" class="col-lg-<?php echo htmlspecialchars(smarty_modifier_replace($_smarty_tpl->tpl_vars['column_width']->value,'.','-'), ENT_QUOTES, 'UTF-8');?>
 steasy_column <?php if ($_smarty_tpl->tpl_vars['sub_column']->value['hide_on_mobile']==1) {?> hidden-md-down <?php } elseif ($_smarty_tpl->tpl_vars['sub_column']->value['hide_on_mobile']==2) {?> hidden-lg-up <?php }?>" >
    				<?php if (!$_smarty_tpl->tpl_vars['sub_column']->value['element']&&isset($_smarty_tpl->tpl_vars['sub_column']->value['columns'])&&count($_smarty_tpl->tpl_vars['sub_column']->value['columns'])) {?>
	                	<div class="steasy_column_block"><?php echo $_smarty_tpl->getSubTemplate ("module:steasycontent/views/templates/hook/steasycontent-columns.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, null, array('columns'=>$_smarty_tpl->tpl_vars['sub_column']->value['columns']), 0);?>
</div>
	                <?php } elseif ($_smarty_tpl->tpl_vars['sub_column']->value['element']&&((isset($_smarty_tpl->tpl_vars['sub_column']->value['elements'])&&count($_smarty_tpl->tpl_vars['sub_column']->value['elements']))||$_smarty_tpl->tpl_vars['sub_column']->value['element']==7)) {?>
	                	<div class="steasy_element_block"><?php echo $_smarty_tpl->getSubTemplate ("module:steasycontent/views/templates/hook/steasycontent-element-".((string)$_smarty_tpl->tpl_vars['sub_column']->value['element']).".tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, null, array('sub_column'=>$_smarty_tpl->tpl_vars['sub_column']->value), 0);?>
</div>
            		<?php }?>
	            </div>
	        <?php } ?>
    ...
    <?php } ?>     
<?php }?>
<!-- MODULE st easy content --><!-- end /var/www/html/SHN/modules/steasycontent/views/templates/hook/steasycontent-columns.tpl --><?php }} ?>
