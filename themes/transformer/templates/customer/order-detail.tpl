...
{block name='page_content'}
  {block name='order_infos'}
    <div id="order-infos">
      <div class="box">
          <div class="row">
            <div class="col-{if $order.details.reorder_url}9{else}12{/if} fs_lg heading_color">
                {l
            ...
            {if $order.details.reorder_url}
              <div class="col-3 text-right">
                <a href="{$order.details.reorder_url}" class="go" title="{l s='Reorder' d='Shop.Theme.Actions'}">{l s='Reorder' d='Shop.Theme.Actions'}</a>
              </div>
            {/if}
  ...
  {block name='order_history'}
    <section id="order-history" class="box">
      <h6 class="page_heading">{l s='Follow your order\'s status step-by-step' d='Shop.Theme.Customeraccount'}</h6>
