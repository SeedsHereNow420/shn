...
{block name='continue_shopping' append}
  <a class="btn btn-default" href="{$urls.pages.index}" title="{l s='Continue shopping' d='Shop.Theme.Actions'}">
...
{block name='cart_actions'}
  <div class="checkout text-center card-block">
    <button type="button" class="btn btn-default disabled" disabled>{l s='Checkout' d='Shop.Theme.Actions'}</button>
  </div>
{/block}
